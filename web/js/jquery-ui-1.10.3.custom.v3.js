...
$.widget( "ui.autocomplete", {
		...
		this._on( this.element, {
			keydown: function( event ) {
				...
				case keyCode.NUMPAD_ENTER:
					...
					if(this.search_pending || this.pending) {
						this.__searchNow(event);
						
					} else if(!this.menu.element.is(":visible")) {
						this.term = null;
						this.__searchNow(event);
	...
	__searchNow: function( event ) {
		...
		this.search_pending = 1;
		if ( this.term !== this._value() ) {
			this.selectedItem = null;
			this.search( null, event, 1 );
		}
		this.search_pending = 0;
	},
	
	_searchTimeout: function( event ) {
		this.search_auto_select = 0;
		clearTimeout( this.searching );
		this.search_pending = 1;
	...
	search: function( value, event, mode ) {
		...
		return this._search( value, mode );
	},

	_search: function( value, mode ) {
		this.pending++;
		this.element.addClass( "ui-autocomplete-loading" );
		this.cancelSearch = false;

		this.source( { term: value, mode: mode }, this._response() );
	},
